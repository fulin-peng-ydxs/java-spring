...
import mybatis.plugs.page.OffsetLimitInterceptor;
...
@MapperScan(basePackages = "mybatis.dao.dao1", sqlSessionFactoryRef = "db1SqlSessionFactory")
@MapperScan(basePackages = "mybatis.dao.dao2", sqlSessionFactoryRef = "db2SqlSessionFactory")
